// app/api/databricks/accounts/route.ts
...
export async function POST(request: NextRequest) {
  try {
    ...
    const { apiUrl, accessToken, warehouseId, tablePath, fields, limit, offset = 0 } = body;
    ...
    if (tablePath.includes('account_vw')) {
      ...
      fieldsList = 'cucode, cuname, cuaddress, cupostcode, cu_country, cu_address_user1, cuphone';
